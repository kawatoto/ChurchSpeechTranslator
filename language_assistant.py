...
direction = 1
direction = int(input("Choose source and target language to translate. 1 for en to es [" + textcolors.blue + str(direction) + textcolors.end + "]: ") or default_device_index)
params = {}

if direction == 1:
    params['source_language'] = "en"
    params['target_language'] = "es"
    params['lang_code_for_polly'] = "es-MX"
    params['voice_id'] = "Mia"
    params['lang_code_for_transcribe'] = "es-US"
else:
